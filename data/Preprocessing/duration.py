...
bikedata = pd.read_csv('data/duration/bikedata_duration_07.csv', usecols=["duration", "started_at", "start_zoneID"])
...
# bikedata.to_csv('data/duration/bikedata_duration_07.csv')
